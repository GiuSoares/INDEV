                            ...
                            <ul class="tabs tab-profile z-depth-1 blue darken-1" style="width: 100%;">
                                ...
                                <div id="descricao" class="tab-content col s12  grey lighten-4">
                                    ...
                                    <div class="col s12  right-align">
                                        <a class="waves-effect waves-light btn"><i class="mdi-maps-rate-review left"></i>Atualizar</a>
                                    </div>
                                </div>
                                        ...
                                        <div class="input-field col s12">
                                            <div id="basic-form" class="section">
                                                <form method="POST" action="func-edit-perfil.php" class="col s12">
                                                    ...
                                                    <div class="col s12  right-align">
                                                        <button type="submit" class=" waves-light btn"><i class="mdi-maps-rate-review left"></i>Atualizar</button>
                                                    </div>
                                                </form>
                                            </div>                                                 
                                        </div>
