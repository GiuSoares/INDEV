            ...
            <ul id="slide-out" class="side-nav fixed leftside-navigation">
                        ...
                        <ul id="profile-dropdown" class="dropdown-content">
                            ...
                            <li>
                                <?php if(isset($_SESSION['login'])){ ?>
                                    <a href="func-logout.php"><i class="mdi-action-exit-to-app"></i>sair</a>
                                <?php }else{
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li><a href="page-index.php"><i class="mdi-action-home"></i>Pagina Inicial</a></li>
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-description"></i>Projeto</a>
                            <div class="collapsible-body">
                                <ul>                                       
                                    <li><a href="page-cadastrar-projeto.php">Criar projeto</a></li>
                                    <li><a href="page-listar-projetos.php">Meus projetos</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-description"></i>Oportunidade</a>
                            <div class="collapsible-body">
                                <ul>                                       
                                    <li><a href="#">oportunidade 01</a></li>
                                    <li><a href="#">oportunidade 02</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
